...
////////////////////////////////
// const recipe1ID = '5ed6604591c37cdc054bc886'
// const recipe2ID = '5ed6604591c37cdc054bc8fd'
const renderPage = function(change) {
    if (change === "add") _modelJs.state.search.page++;
    if (change === "minus") _modelJs.state.search.page--;
    const page = _modelJs.getSearchResultPage();
    (0, _resultsViewDefault.default).render(page);
...
const controlSearchResults = async function() {
    try {
        ...
        renderPage();
        (0, _paginationViewJsDefault.default).addHandlerButtons(renderPage);
    } catch (err) {
        console.log(err);
    }
};
...
const controlAddBookmark = function() {
    ...
    else _modelJs.removeBookmarks(_modelJs.state.recipe.id);
    (0, _recipeViewJsDefault.default).update(_modelJs.state.recipe);
...
const controlUpload = async function(data) {
    try {
        ...
        (0, _addRecipeViewDefault.default).renderMessage("Upload successful.");
        (0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
        (0, _recipeViewJsDefault.default).render(_modelJs.state.recipe);
        //  change id in url 
...
const deleteRecipes = async function(id) {
    (0, _recipeViewJsDefault.default).renderError("You have deleted this recipe");
    _modelJs.removeBookmarks(_modelJs.state.recipe.id);
    await _modelJs.deleteRecipe(id);
    (0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
    location.reload();
};
const init = function() {
    ...
    (0, _recipeViewJsDefault.default).addHandlerBookmarks(controlAddBookmark);
    (0, _recipeViewJsDefault.default).addHandlerDelete(deleteRecipes);
    (0, _searchViewJsDefault.default).addHandlerSearch(controlSearchResults);
    (0, _addRecipeViewDefault.default).addHandlerUpload(controlUpload);
};
init();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./views/recipeView.js":"l60JC","regenerator-runtime/runtime":"dXNgZ","./views/searchView.js":"9OQAM","./views/resultsView":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookmarksView.js":"4Lqzq","./config.js":"k5Hzs","./views/addRecipeView":"i6DNj","regenerator-runtime":"dXNgZ"}],"gkKU3":[function(require,module,exports) {
...
const state = {
    ...
    search: {
        query: "",
        results: [],
        resultsPerPage: (0, _configJs.pageNum),
        page: 1
    },
    bookmarks: []
};
...
const uploadRecipe = async function(newRecipe) {
    try {
        const ingredients = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith("ingredient") && entry[1] !== "").map((ing)=>{
            ...
            if (ingArr.length !== 3) throw new Error("Wrong ingredient format! Please use the instructed format :)");
...
const deleteRecipe = async function(id) {
    try {
        const data = await (0, _helpersJs.deleteData)(`${(0, _configJs.API_URL)}/${id}?key=${(0, _configJs.KEY)}`);
        if (state.bookmarks.some((bookmark)=>bookmark.id === id)) state.recipe.bookmarked = false;
    } catch (err) {
        console.error(`${err} !!!`);
    }
};

},{"regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./helpers.js":"hGI1E","./config.js":"k5Hzs"}],"dXNgZ":[function(require,module,exports) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./config.js":"k5Hzs","regenerator-runtime":"dXNgZ"}],"k5Hzs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "API_URL", ()=>API_URL);
parcelHelpers.export(exports, "TIMEOUT_SEC", ()=>TIMEOUT_SEC);
parcelHelpers.export(exports, "pageNum", ()=>pageNum);
parcelHelpers.export(exports, "KEY", ()=>KEY);
parcelHelpers.export(exports, "MODAL_CLOSE_SEC", ()=>MODAL_CLOSE_SEC);
const API_URL = "https://forkify-api.herokuapp.com/api/v2/recipes";
const TIMEOUT_SEC = 10;
const pageNum = 10;
const KEY = "ee53dac1-f17a-4f4f-9e67-156f5985be96";
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    addHandlerDelete(handler) {
        this._parentEl.addEventListener("click", function(e) {
            ...
            if (!deleteBtn) return;
            deleteBtn.addEventListener("click", handler(id));
        });
    }
    ...
    _generateMarkup() {
        ...
        <div class="recipe__details">
          ...
          <div class="recipe__user-generated deleteBtn ${this._data.key ? "" : "hidden"}">
            <svg>
          ...
          <button class="button--round btn--bookmark">
            <svg>
        ...
        <div class="recipe__directions">
            ...
            <p class="recipe__directions-text">
              This recipe was carefully designed and tested by <span class="recipe__publisher">${this._data.publisher}</span>. Please check out directions at their website.
            </p>
            <a href="${this._data.sourceURL}" target="_blank" class="btn--small recipe__btn">
...
},{"url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","fracty":"hJO4d","./View.js":"5cUXS"}],"loVOp":[function(require,module,exports) {
...
},{"url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","regenerator-runtime":"dXNgZ"}],"9OQAM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class searchView {
...
class PreviewView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup(result) {
        ...
        return `
      <li class="preview">
      <a href="#${this._data.id}" class="preview__link ${id === this._data.id ? "preview__link--active" : ""}">
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    addHandlerButtons(handler) {
        this._parentEl.addEventListener("click", function(e) {
            ...
            if (!btn) return;
            if (btn.classList.contains("pagination__btn--next")) handler("add");
            if (btn.classList.contains("pagination__btn--prev")) handler("minus");
        });
    }
    _generateMarkup() {
        ...
        // middle page of many
        if (this._data.page > 1) return `<button class="btn--inline pagination__btn--prev">
                        <svg class="search__icon">
                          <use href="${0, _iconsSvgDefault.default}#icon-arrow-left"></use>
                        </svg>
                        <span>Page ${this._data.page - 1}</span>
...
class BookmarksView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = "No bookmarks yet. Select one and try again :)";
    _message = "";
    addHandlerRender(handler) {
...
class AddRecipeView extends (0, _viewJsDefault.default) {
    ...
    _addRecipe = document.querySelector(".add-recipe-window");
    _btnOpen = document.querySelector(".nav__button--add-recipe");
    ...
    closeWindow() {
        ...
        this._addRecipe.classList.add("hidden");
    }
